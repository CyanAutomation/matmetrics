...
const TransformPracticeInputSchema = z.object({
  ...
  customPrompt: z
    ...
    .optional()
    .describe(
      'Optional custom instructions for the AI on how to style the transformed entry.'
    ),
});
export type TransformPracticeInput = z.infer<
  typeof TransformPracticeInputSchema
>;
...
const TransformPracticeOutputSchema = z.object({
  transformedDescription: z
    .string()
    .describe(
      'A well-structured, terminologically accurate training diary entry with a personal and neutral tone.'
    ),
});
export type TransformPracticeOutput = z.infer<
  typeof TransformPracticeOutputSchema
>;
