    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <Card className="border-primary/10">
        <CardHeader className="bg-primary/5 border-b">
          ...
          <CardDescription>
            Operational management view for installed plugins. Creation and
            editing flows are handled outside this page.
          </CardDescription>
        </CardHeader>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            View all installed plugin manifests, control enabled state, and
            review per-plugin issue details.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            {validCandidateEntries.map((entry) => {
              ...
              const manifestId = entry.result.manifest.id;
                ...
                >
                  ...
                  {entry.result.issues.length === 0 ? (
                    ...
                    <ul className="space-y-2">
                      {entry.result.issues.map((issue, issueIndex) => (
                        <li
