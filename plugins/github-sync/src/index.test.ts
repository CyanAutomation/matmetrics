...
test('initPlugin registers github-sync ids exactly once', () => {
  ...
  assert.deepEqual(registerCalls, ['github-sync-dashboard-tab']);
  assert.deepEqual(registerComponentCalls, ['github_settings']);
});
